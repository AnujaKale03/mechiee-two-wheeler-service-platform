...
export default function AdminDashboardScreen({ navigation }) {
  ...
  // ── jumpTo switches between sibling tabs; navigate() doesn't work for tabs ──
  const quickActions = [
    { label: "👥  View Customers",      tab: "Customers"  },
    { label: "🔧  View Mechanics",      tab: "Mechanics"  },
    { label: "⏳  Waitlisted Bookings", tab: "Waitlisted" },
  ];
      ...
      <View style={styles.card}>
        ...
        {quickActions.map(({ label, tab }) => (
          <TouchableOpacity
            ...
            onPress={() => navigation.jumpTo(tab)} // ← jumpTo for sibling tabs
          >
