        ...
        <View style={styles.avatarWrap}>
          {image ? (
            ...
            <View style={styles.avatarFallback}>
              <Text style={styles.avatarInitial}>{mechanic.name?.[0] ?? "M"}</Text>
            </View>
          )}
...
const styles = StyleSheet.create({
  card: {
    ...
    borderLeftWidth: 4, borderLeftColor: COLORS.mechanicAccentPastel,
  },
  topRow: { flexDirection: "row", alignItems: "center", marginBottom: SPACING.md },
  avatarWrap: { width: 56, height: 56, borderRadius: RADIUS.full, marginRight: SPACING.md, position: "relative" },
  avatarImg: {
    width: 56, height: 56, borderRadius: RADIUS.full,
    borderWidth: 2, borderColor: COLORS.mechanicAccentPastel,
  },
  avatarFallback: {
    width: 56, height: 56, borderRadius: RADIUS.full,
  ...
  barFooter: { flexDirection: "row", justifyContent: "space-between", marginTop: SPACING.xs },
